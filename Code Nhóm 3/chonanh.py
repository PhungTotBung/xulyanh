...
class ImageFilterApp:
    def __init__(self, master):
        self.master = master
        self.master.title("Nhóm 3 - lọc 1 ảnh")
    ...
    def apply_filter(self):
        ...
        if self.original_image is None:
            messagebox.showerror("Error", "Hãy chọn hình ảnh!")
            return

        if selected_filter == "":
            messagebox.showerror("Error", "Hãy chọn bộ lọc!")
            return
        ...
        if selected_filter == "Smooth/Low Pass Filter":
            ...
            filtered_image = self.laplacian(self.original_image)
    ...
    def save_image(self):
        if self.filtered_image is not None:
            ...
            if file_path:
                ...
                messagebox.showinfo("Lưu Ảnh", "Lưu Hình Ảnh Thành Công!")
        else:
            messagebox.showwarning("Lưu Ảnh", "Lưu Hình Ảnh Thất Bại!")
